...
pub const DISABLE_BASIC_IRQS	: u32 = PBASE+0x0000B224; // timer registers
pub const TIMER_CS      : u32 =  PBASE+0x00003000;
pub const TIMER_CLO     : u32 =  PBASE+0x00003004;
pub const TIMER_CHI     : u32 =  PBASE+0x00003008;
pub const TIMER_C0      : u32 =  PBASE+0x0000300C;
pub const TIMER_C1      : u32 =  PBASE+0x00003010;
pub const TIMER_C2      : u32 =  PBASE+0x00003014;
pub const TIMER_C3      : u32 =  PBASE+0x00003018;
